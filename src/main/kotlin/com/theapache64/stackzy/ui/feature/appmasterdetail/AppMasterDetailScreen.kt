...
@Composable
fun SelectAppScreen(
    appListViewModel: AppMasterDetailViewModel,
    onBackClicked: () -> Unit,
    ...
    CustomScaffold(
        ...
        Column {
            ...
            if (selectedTabIndex != AppMasterDetailViewModel.TAB_NO_TAB) {
                TabRow(
                    ...
                    AppMasterDetailViewModel.tabsMap.entries.forEach { tabEntry ->
                        Tab(
